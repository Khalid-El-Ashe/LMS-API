...
//Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('course')->group(function () {
        ...
        Route::post('/create', [CourseController::class, 'createCourse'])->middleware(['auth:sanctum', 'can:create-course']);

        Route::get('/{course}/links/', [CourseController::class, 'getLinksByCourse']);
        Route::post('/{course}/new-links/', [CourseController::class, 'newLinks'])->middleware(['can:create-link']);
